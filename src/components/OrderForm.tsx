...
const generateRandomData = (): OrderFormData => {
  ...
  const products = [
    "Laptop Computer", "Wireless Headphones", "Coffee Maker", 
    "Office Chair", "Smartphone", "Tablet", "Keyboard", 
    "Monitor", "Desk Lamp", "Bluetooth Speaker", "Gaming Mouse", 
    "Webcam", "External Hard Drive", "Power Bank", "Wireless Charger",
  ];
